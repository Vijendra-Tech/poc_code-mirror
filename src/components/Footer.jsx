...
const Footer = () => {
  return (
    <div className=" bg-gray-900 fixed h-8 bottom-0 px-2 py-1 flex items-center justify-center w-full text-xs text-white ">
      <span>
        Built with{" "}
        <svg
          height="2500"
        ...
        Code at{" "}
        <a
          href="https://github.com/Vijendra-Tech/poc_code-mirror"
          target="__blank"
          className="text-white  hover:bg-red-500 hover:text-white font-medium"
        >
          GitHub.{" "}
